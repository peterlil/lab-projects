...
namespace az_func_timeout_vs
{
    public class TimerTimeout
    {
        ...
        public TimerTimeout(ILoggerFactory loggerFactory)
        {
            _logger = loggerFactory.CreateLogger<TimerTimeout>();
        ...
        public async Task Run([TimerTrigger("32 16 * * *")] TimerInfo myTimer)
        {
            _logger.LogInformation($"C# Timer trigger function executed at: {DateTime.Now}");
            
            
            var appName = "az-func-timeout-vs:3";
